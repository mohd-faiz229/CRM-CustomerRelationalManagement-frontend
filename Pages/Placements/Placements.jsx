  ...
  return (
    <div className="min-h-screen  p-4 md:p-10 font-sans">
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className=" border border-white/25 rounded-[2.5rem] overflow-hidden shadow-2xl">
          <div className="overflow-x-auto">
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="border-t border-white/25 bg-white/[0.02]">
                  <th className="px-8 py-6 text-[10px] font-black  uppercase tracking-widest">Candidate</th>
                  <th className="px-8 py-6 text-[10px] font-black  uppercase tracking-widest hidden md:table-cell">Specialization</th>
                  <th className="px-8 py-6 text-[10px] font-blackuppercase tracking-widest">Organization</th>
                  <th className="px-8 py-6 text-[10px] font-black  uppercase tracking-widest text-right">Designation</th>
                </tr>
              </thead>
                  ...
                  <tr key={index} className="group hover:bg-white/[0.03] transition-all">
                    <td className="px-8 py-8">
                      <div className="flex items-center gap-4">
                        <div className="w-10 h-10 rounded-xl bg-white/5 border border-white/0 flex items-center justify-center text-blue-500 font-black italic">
                          {student.name.charAt(0)}
                        </div>
                        <div>
                          <p className="text-sm font-black  italic tracking-tight uppercase group-hover:text-blue-400 transition-colors">
                            {student.name}
                          </p>
                          <p className="text-[9px] font-bold md:hidden uppercase mt-0.5">
                            {student.course}
                          </p>
                        </div>
                      </div>
